<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreateGraduation.aspx.cs" Inherits="Admin.CreateGraduation" %>
<!DOCTYPE html>
...
<span class="dropdown-text" style="text-align: center;color: #fff; font-size: 18px; font-weight: bold;">Settings</span>
 <div class="buttons">
   ...
   Insert Graduation Plan </h3>  
            <div class="info-bar">
                                 Semester Code
                    </div>
        <asp:TextBox ID="txtSemester" runat="server" CssClass="input-style" required ></asp:TextBox>
            <div class="info-bar">
...
<asp:TextBox ID="txtCreditHours" runat="server" CssClass="input-style" required></asp:TextBox>
            <div class="info-bar">
                         Student ID
            </div>

<asp:TextBox ID="studentid" runat="server"  CssClass="input-style" required></asp:TextBox>
