<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminInstallment.aspx.cs" Inherits="Admin.AdminInstallment" %>
...
<div>
    ...
    <asp:TextBox ID="txtPaymentID" runat="server" ClientIDMode="Static" CssClass="txtPaymentID" required></asp:TextBox><br>

    <asp:Button ID="btnIssueInstallment" runat="server" Text="Issue Installment" OnClick="btnIssueInstallment_Click"
        CssClass="btnIssueInstallment" />
</div>
</div>
        <script>
