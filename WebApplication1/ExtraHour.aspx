<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExtraHour.aspx.cs" Inherits="Admin.ExtraHour" %>
...
<span class="dropdown-text" style="text-align: center;color: #fff; font-size: 18px; font-weight: bold;">Settings</span>
 <div class="buttons">
    ...
    <div class="user-box" style="top:400px;left:50%"><h3 style="text-align:center">
     Approve/Reject Extra Credit Hours Request </h3>  
            <div class="info-bar">
                         Request Id
            </div>
<asp:TextBox ID="request" runat="server" CssClass="input-style" required></asp:TextBox>
