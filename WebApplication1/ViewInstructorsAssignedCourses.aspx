<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewInstructorsAssignedCourses.aspx.cs" Inherits="Admin.ViewInstructorsAssignedCourses" %>
   ...
   <span class="dropdown-text" style="text-align: center;color: #fff; font-size: 18px; font-weight: bold;">Update</span>
    ...
    <div class="user-box" style="top:350px;left:50%">
        <h3 style="text-align:center">
           Instructors With Assigned Courses </h3>
       
    <asp:GridView ID="GridViewInstructors" runat="server" CssClass="custom-gridview">
