<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeleteSlots.aspx.cs" Inherits="Admin.DeleteSlots" %>
...
<div class="content">
 <div class="container">
   ...
   <span class="dropdown-text" style="text-align: center;color: #fff; font-size: 18px; font-weight: bold;">Update</span>
    ...
    <h2>Delete Slots for Current Semester</h2>
<div>
...
<div>
    ...
    <asp:TextBox ID="txtSemester" runat="server" style="width: 100%; padding: 8px; margin-bottom: 15px; border: 1px solid #ccc; border-radius: 4px; box-sizing: border-box;" required></asp:TextBox><br>

    <asp:Button ID="btnDeleteSlots" runat="server" Text="Delete Slots" OnClick="btnDeleteSlots_Click" style="width: 100%; padding: 10px; border: none; border-radius: 4px; background-color: #610c04 ;cursor: pointer; transition: background-color 0.3s ease;" />
</div>
</div>
