<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeleteCourse.aspx.cs" Inherits="Admin.DeleteCourse" %>
 ...
 <div class="container">
   ...
   <span class="dropdown-text" style="text-align: center;color: #fff; font-size: 18px; font-weight: bold;">Update</span>
    ...
    <div>
        ...
        <asp:TextBox ID="txtCourseID" runat="server" placeholder="Enter Course ID" required></asp:TextBox><br />
        <asp:Button ID="btnDelete" runat="server" Text="Delete Course" OnClick="btnDelete_Click" />
    </div>
</div>
    </div>
        <script>
