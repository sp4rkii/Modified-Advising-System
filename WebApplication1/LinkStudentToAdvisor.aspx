<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LinkStudentToAdvisor.aspx.cs" Inherits="Admin.LinkStudentToAdvisor" %>
    ...
    <div class="buttons">
       ...
       <div class="user-box" style="top:400px;left:50%;background-color:darkred"><h3 style="text-align:center">
        ...
        <div>
            ...
            <asp:TextBox ID="txtAdvisorId" runat="server" type="number" required></asp:TextBox><br>

            <asp:Button ID="btnLinkStudentToAdvisor" runat="server" Text="Link Student to Advisor" OnClick="btnLinkStudentToAdvisor_Click" />
        </div>
