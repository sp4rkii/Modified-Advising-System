<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddNewSemester.aspx.cs" Inherits="Admin.AddNewSemester" %>
    ...
    <div class="buttons">
       ...
       <div class="user-box" style="top:400px;left:50%;background-color:darkred"><h3 style="text-align:center">
        ...
        <div>
            ...
            <asp:TextBox ID="txtStartDate" runat="server" type="date" required></asp:TextBox><br>

            <label for="endDate">End Date:</label>
            <asp:TextBox ID="txtEndDate" runat="server" type="date" required></asp:TextBox><br>
