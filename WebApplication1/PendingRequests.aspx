<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PendingRequests.aspx.cs" Inherits="Admin.PendingRequests" %>
...
<div class="content">
 <div class="container">
   ...
   <span class="dropdown-text" style="text-align: center;color: #fff; font-size: 18px; font-weight: bold;">Update</span>
    ...
    <asp:GridView ID="GridViewRequests" runat="server" CssClass="custom-gridview">
