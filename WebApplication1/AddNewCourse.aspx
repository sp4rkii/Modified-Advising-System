<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddNewCourse.aspx.cs" Inherits="Admin.AddNewCourse" %>
    ...
    <div class="buttons">
       ...
       <div class="user-box" style="top:400px;left:50%;background-color:darkred"><h3 style="text-align:center">
        ...
        <div>
            ...
            <asp:TextBox ID="txtMajor" runat="server" required></asp:TextBox><br>

            <label for="semester">Semester:</label>
            <asp:TextBox ID="txtSemester" runat="server" type="number" required></asp:TextBox><br>

            <label for="creditHours">Credit Hours:</label>
            <asp:TextBox ID="txtCreditHours" runat="server" type="number" required></asp:TextBox><br>

            <label for="courseName">Course Name:</label>
            <asp:TextBox ID="txtCourseName" runat="server" required></asp:TextBox><br>

            <label for="isOffered">Is Offered:</label>
            <asp:DropDownList ID="ddlIsOffered" runat="server" required>
