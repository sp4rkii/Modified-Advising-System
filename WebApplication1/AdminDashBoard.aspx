<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminDashBoard.aspx.cs" Inherits="Admin.AdminDashBoard" %>
...
.container {
       ...
       @keyframes dropDown {
        ...
        .welcome-message {
            ...
            animation: dropDown 1.5s ease-out forwards; /* Animation name, duration, easing, and forwards to keep the final state */
      ...
      position: absolute;
      top: -30%; /* Start above the visible area */
      left: 50%;
      transform: translate(-50%, -50%);
      animation: descend 2s cubic-bezier(0.68, -0.55, 0.27, 1.55) forwards; /* Descend animation */
    }

    @keyframes descend {
      0% {
        top: -30%; /* Initial position above the visible area */
        opacity: 0; /* Initially transparent */
      }
      100% {
        top: 50%; /* Final position at the middle of the page */
         opacity: 1; /* Fully visible */
      }
    }
    .welcome-text {
      color: transparent; /* Transparent text initially */
      font-size: 1.8em;
      line-height: 1.5;
      margin-bottom: 15px;
      background: linear-gradient(to right, #ff0000, #8b0000); /* Red to maroon gradient for text */
