<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminLinkInstructor.aspx.cs" Inherits="Admin.AdminLinkInstructor" %>
   ...
   <span class="dropdown-text" style="text-align: center;color: #fff; font-size: 18px; font-weight: bold;">Update</span>
    <div class="buttons">
       ...
       <div class="user-box" style="top:400px;left:50%;background-color:darkred"><h3 style="text-align:center">
            Link Instructor to a specific course </h3> 
           <div>
        ...
        <div>
            ...
            <asp:TextBox ID="txtSlotId" runat="server" type="number" required></asp:TextBox><br>
