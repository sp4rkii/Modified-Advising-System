<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeleteCourse1.aspx.cs" Inherits="Admin.DeleteCourse1" %>
...
<span class="dropdown-text" style="text-align: center;color: #fff; font-size: 18px; font-weight: bold;">Settings</span>
 <div class="buttons">
    ...
    Delete Course From A  Graduation Plan </h3>  
            <div class="info-bar">
                         Semester Code
            </div>
...
<asp:TextBox ID="courseId" runat="server"  CssClass="input-style" required></asp:TextBox>
            <div class="info-bar">
                         Student ID
            </div>
