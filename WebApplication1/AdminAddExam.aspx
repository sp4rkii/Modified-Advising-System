<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminAddExam.aspx.cs" Inherits="Admin.AdminAddExam" %>
...
input[type="datetime-local"]:focus {
    outline: none;
    border-color: #45b3e7;
    box-shadow: 0 0 5px rgba(69, 179, 231, 0.5);
}
...
.ajax__calendar_container {
 ...
 /* Remove background colors and borders for the message boxes */
 .message {
     margin-bottom: 15px;
     padding: 10px;
     border-radius: 5px;
...
<div class="content">
 <div class="container">
   ...
   <span class="dropdown-text" style="text-align: center;color: #fff; font-size: 18px; font-weight: bold;">Update</span>
    ...
    <div class="user-box" style="top:350px;left:50%;background-color:darkred">
    <h2>Add Exam</h2>
<div>
    <asp:Label ID="lblError" runat="server" ForeColor="Red" EnableViewState="False"></asp:Label>
    <asp:Label ID="lblResult" runat="server" ForeColor="green" EnableViewState="False"></asp:Label>
    
    <label for="txtType">Exam Type:</label>
    <asp:TextBox ID="txtType" runat="server" ClientIDMode="Static" CssClass="txtType" required></asp:TextBox><br>

    <label for="txtDate">Start Date:</label>
    <asp:TextBox ID="txtDate" runat="server" ClientIDMode="Static" CssClass="txtStartDate" type="datetime-local" required></asp:TextBox><br>

    <label for="txtCourseID">Course ID:</label>
    <asp:TextBox ID="txtCourseID" runat="server" ClientIDMode="Static" CssClass="txtCourseID" required></asp:TextBox><br>

    <asp:Button ID="btnAddExam" runat="server" Text="Add Exam" OnClick="btnAddExam_Click"
        style="width: 100%; padding: 10px; border: none; border-radius: 4px; background-color: #610c04; color: #fff; cursor: pointer; transition: background-color 0.3s ease;" />
