<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LinkStudentToCourse.aspx.cs" Inherits="Admin.LinkStudentToCourse" %>
 ...
 <div class="container">
   ...
   <span class="dropdown-text" style="text-align: center;color: #fff; font-size: 18px; font-weight: bold;">Update</span>
    <div class="buttons">
       ...
       <div class="user-box" style="top:400px;left:50%;background-color:darkred"><h3 style="text-align:center">
            Link Student To Course </h3> 
           <div>
        ...
        <div>
            ...
            <asp:TextBox ID="txtCourseId" runat="server" type="number" required></asp:TextBox><br>

            <label for="instructorId">Instructor ID:</label>
            <asp:TextBox ID="txtInstructorId" runat="server" type="number" required></asp:TextBox><br>

            <label for="studentId">Student ID:</label>
            <asp:TextBox ID="txtStudentId" runat="server" type="number" required></asp:TextBox><br>

            <label for="semesterCode">Semester Code:</label>
            <asp:TextBox ID="txtSemesterCode" runat="server" required></asp:TextBox><br>

            <asp:Button ID="btnLinkStudentToCourse" runat="server" Text="Link Student to Course" OnClick="btnLinkStudentToCourse_Click" />
        </div>
