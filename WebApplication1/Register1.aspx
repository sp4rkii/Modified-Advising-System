<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register1.aspx.cs" Inherits="Admin.Register1" %>
...
<body>
  ...
  <asp:TextBox ID="location" runat="server" CssClass="input-style" ></asp:TextBox>
