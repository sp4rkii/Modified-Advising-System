<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AssignedStudents.aspx.cs" Inherits="Admin.AssignedStudents" %>
...
<span class="dropdown-text" style="text-align: center;color: #fff; font-size: 18px; font-weight: bold;">Settings</span>
 <div class="buttons">
    ...
    <div class="user-box" style="top:200px;left:50%"><h3 style="text-align:center">
   Choose A Major </h3>  
        <asp:TextBox ID="Txtmajor" runat="server" CssClass="input-style" required >
        </asp:TextBox> 
        <asp:Button ID="confirm" runat="server" OnClick="confirmClick" Text="Confirm" CssClass="submit-style" />
    </div>
  
    <div class="user-box" style="top:400px;left:50%"> <asp:Literal ID="lblError" runat="server" ></asp:Literal>
        <h3 style="text-align:center">
           My Assigned Students </h3>
       <asp:Literal ID="lblError1" runat="server" ></asp:Literal>
    <asp:GridView ID="GridViewAdvisors" runat="server" CssClass="custom-gridview">
